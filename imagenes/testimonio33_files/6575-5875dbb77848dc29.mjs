"use strict";(self.__LOADABLE_LOADED_CHUNKS__=self.__LOADABLE_LOADED_CHUNKS__||[]).push([[6575],{3808:(e,t,n)=>{n.d(t,{Z:()=>p});var a=n(667294),i=n(616550),r=n(741983),o=n(340523),s=n(5859),l=n(149722),u=n(961550),m=n(408998),c=n(995026);function p(){let e=(0,l.Z)(),t=(0,o.F)(),{isRTL:n}=(0,s.B)(),p=(0,i.TH)(),d=(0,i.k6)(),_=p.search,h=(0,c.Z)(p)&&!n&&e.isAuth&&!e.isPartner&&!(0,r.OK)(p);return(0,a.useEffect)(()=>{_.includes("enable_vertical_nav")&&((0,m.M)(),d.push("/"),window.location.reload())},[_,d]),{enabled:h&&t.checkExperiment("web_vertical_nav").anyEnabled,group:h?t.checkExperiment("web_vertical_nav").group:u.lR.NONE}}},922719:(e,t,n)=>{n.d(t,{CC:()=>i,Ll:()=>o,XF:()=>r});let a=(e,t,n)=>({x:Math.floor(e*Math.cos(n)),y:Math.floor(t*Math.sin(n))}),i=(e,t)=>a(t/2,e/2,2*Math.random()*Math.PI),r=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,o=e=>["@-webkit-keyframes","@keyframes"].map(t=>e.map(e=>t+" "+e).join("\n")).join("\n")},775089:(e,t,n)=>{n.r(t),n.d(t,{default:()=>M});var a=n(667294),i=n(883119),r=n(214877),o=n(103322);function s(e,t,n){var a;return(t="symbol"==typeof(a=function(e,t){if("object"!=typeof e||null===e)return e;var n=e[Symbol.toPrimitive];if(void 0!==n){var a=n.call(e,t||"default");if("object"!=typeof a)return a;throw TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(t,"string"))?a:String(a))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}let l={},u=e=>{let t=e.__id||e.id;return"string"==typeof t&&t||null};class m{constructor(){s(this,"idMap",new Map),s(this,"objMap",new WeakMap)}get(e){let t=u(e);return this.objMap.get(e)??(t?this.idMap.get(t):void 0)}has(e){let t=u(e);return this.objMap.has(e)??(!!t&&this.idMap.has(t))}set(e,t){let n=u(e);n&&this.idMap.set(n,t),this.objMap.set(e,t)}reset(){this.idMap=new Map,this.objMap=new WeakMap}}var c=n(401111),p=n(547643),d=n(667677),_=n(213377),h=n(406893),b=n(340523),f=n(5859),w=n(554786),y=n(953565),v=n(84768),x=n(785893);function g({analyticsData:e,children:t,idx:n,isMeasuring:i,masonryV2ExpName:r,masonryV2ExpGroup:s}){let l=(0,w.ZP)(),{isAuthenticated:u}=(0,f.B)(),m=(0,v.MM)();return(0,a.useEffect)(()=>{if(e.current[n]){let{fetchTimestamp:t,measureTimestamp:a,hasRendered:o,pageCount:c}=e.current[n]??{},p={deviceType:l,experimentName:r,experimentGroup:s,handlerId:m,isAuthenticated:u,pageCount:c};i&&!a&&(e.current[n].measureTimestamp=Date.now(),(0,y.LY)("webapp.masonry.itemMeasureStart",Date.now()-t,{tags:p})),i||o||((0,y.LY)("webapp.masonry.itemRenderStart",Date.now()-a,{tags:p}),e.current[n].hasRendered=!0)}},[i]),(0,x.jsx)(o.Z,{name:"MasonryItem",children:t})}function M(e){let{align:t,cacheKey:n,id:s,isGridCentered:u=!0,items:M,layout:E,loadItems:C,masonryRef:S,optOutFluidGridExperiment:$=!1,renderItem:k,scrollContainerRef:O,virtualize:N=!0,_getColumnSpanConfig:R,_dynamicHeights:j,useLoadingState:I}=e,T=(0,w.ZP)(),{isAuthenticated:A,isRTL:L}=(0,f.B)(),{logContextEvent:W}=(0,r.v)(),D=(0,b.F)(),Z="desktop"===T,P=(0,v.MM)(),B=(0,a.useRef)(M.map(()=>({fetchTimestamp:Date.now(),measureTimestamp:Date.now(),hasRendered:!1,pageCount:0}))),{_loadingStateItems:F,_renderLoadingStateItems:V}=(0,d.Z)({useLoadingState:I}),{experimentalColumnWidth:H,experimentalGutter:z,anyEnabled:G}=(0,c.Z)("flexible"!==E&&!$),Y=e.serverRender??!!Z,U="flexible"===E||"desktop"!==T||G,X=Y?"serverRenderedFlexible":"flexible",J=e.columnWidth??H??_.yF;U&&(J=Math.floor(J));let K=e.gutterWidth??z??(Z?_.oX:1),Q=e.minCols??_.yc,q=(0,a.useRef)(0),ee=J+K,et=function(e){if(null==e)return;let t=function(e){let t=l[e];return t&&t.screenWidth===window.innerWidth||(l[e]={screenWidth:window.innerWidth}),l[e]}(e);return t.measurementCache||(t.measurementCache=new m),t.measurementCache}(n),en=(0,a.useCallback)(()=>O?.current||window,[O]),ea=(0,a.useRef)(!0),{anyEnabled:ei}=D.checkExperiment("web_masonry_ssr_container_query"),er=u&&ea.current?"centered":"",{className:eo,styles:es}=function(e){let t=`m_${Object.keys(e).reduce((t,n)=>{let a=e[n];return null==a||"object"==typeof a||"function"==typeof a?t:"boolean"==typeof a?t+(a?"t":"f"):t+a},"").replace(/\:/g,"\\:")}`,{flexible:n,gutterWidth:a,isRTL:i,itemWidth:r,maxColumns:o,minColumns:s,items:l,_getColumnSpanConfig:u}=e,m=u?l.map((e,t)=>({index:t,columnSpanConfig:u(e)??1})).filter(e=>1!==e.columnSpanConfig):[],c=r+a,p=Array.from({length:o+1-s},(e,t)=>t+s).map(e=>{let l=e===s?0:e*c,u=e===o?null:(e+1)*c-.01,{styles:p,numberOfVisibleItems:d}=m.reduce((i,o)=>{let{columnSpanConfig:s}=o,l=Math.min(function({columnCount:e,columnSpanConfig:t}){return"number"==typeof t?t:t[e<=2?"sm":e<=4?"md":e<=8?"lg":"xl"]??1}({columnCount:e,columnSpanConfig:s}),e),u=null!=o.index&&i.numberOfVisibleItems>=l+o.index,m=n?100/e*l:r*l+a*(l-1),{numberOfVisibleItems:c}=i;return u?c-=l-1:o.index<c&&(c+=1),{styles:i.styles.concat(function({className:e,index:t,columnSpanConfig:n,visible:a,width:i,flexible:r}){let o="number"==typeof n?n:btoa(JSON.stringify(n));return r?`
    ...
    `;return{minWidth:l,maxWidth:u,styles:`
      ...
      ${p}
    `}}),d=p.map(({minWidth:e,maxWidth:t,styles:n})=>`
